...
<script>
    export default {
        ...
        methods: {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.put('https://shmly.top/repair/user/edit', this.ruleForm).then(function (resp) {
                            if(resp.status == '200'){
        ...
        created() {
            ...
            const _this = this;
            axios.get('https://shmly.top/repair/user/queryById?id=' + this.$route.query.id).then(function (resp) {
