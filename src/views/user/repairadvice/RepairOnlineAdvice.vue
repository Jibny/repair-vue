    ...
    export default {
        ...
        methods: {
            ...
            handleClickPage(currentPage) {
                const _this = this
                axios.get('https://shmly.top/repair/online/listByUserNumber?pageNo=' + currentPage + '&pageSize=6&userNumber='+this.number+'&status=正在处理').then(function (resp) {
        ...
        created() {
            ...
            axios.get('https://shmly.top/repair/user/queryById?id='+sessionStorage.getItem("userid")).then(function (resp) {
                ...
                axios.get('https://shmly.top/repair/online/listByUserNumber?pageNo=1&pageSize=6&userNumber='+_this.number+'&status=正在处理').then(function (resp) {
                    _this.tableData = resp.data.result.records
                    _this.total = resp.data.result.total
                    console.log(resp.data)
                })
